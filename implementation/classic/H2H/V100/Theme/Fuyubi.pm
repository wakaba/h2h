...
sub _init {
  ...
  $self->{_HTML}->{start} = '<div%ATTR%>'.
    ...
    '<img src="favicon" class="favicon" alt="¡þ" '.
...
<div>
	...
	<label class="comments">°ì¸À(¤â¤·¤¢¤ì¤Ð¡£): <input type="text" name="comment" value=""></label>
	<label class="names">Ì¾Á°(¤è¤í¤·¤±¤ì¤Ð¡£): <input type="text" name="name" value=""></label>
